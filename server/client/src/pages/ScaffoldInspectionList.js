...
function ScaffoldInspectionList() {
    ...
    return (
       ...
       <div className='w-full flex h-auto p-6'>
          <Sidebar needed={needed}/>
           ...
           <p className='text-lg xxl:text-2xl text-slate-400 pb-1 ml-2 mt-4 mb-3'>Scaffold inspection list</p>
             ...
             <div className='lg:w-full overflow-x-auto lg:overflow-x-hidden pr-1 '>
               ...
               {Data.map((data) => {
                 ...
                 <td className='w-2/12 text-center border-[1px] border-gray-300 pl-3 p-1 text-[10px] xxl:text-[13px]'>{data.date}</td>
                 ...
                 <td className=' w-2/12 border-t-[1px] border-r-[1px] border-b-[1px] border-gray-300 p-1'>
                   <div className='flex flex-row justify-center space-x-2 xxl:space-x-5 px-4'>
                     ...
                     <EditIcon sx={{width:'17px',height:"17px"}} className="text-lightgreen hover:text-darkgreen cursor-pointer"/><p className='text-[10px] xxl:text-sm'>Create</p>
                    </div>
...
export default ScaffoldInspectionList