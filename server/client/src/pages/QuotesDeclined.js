...
function QuotesDecline() {
  ...
  return (
   ...
   <div className='w-full flex h-auto p-6 overflow-y-scroll scrollbar-hide'>
      <Sidebar needed={needed}/>

       <div className='lg:basis-3/4 w-full overflow-x-scroll scrollbar-hide'>
       <p className='text-lg xxl:text-2xl text-slate-400 pb-1 ml-2 mt-4 mb-3'>Quotes Declined</p>
